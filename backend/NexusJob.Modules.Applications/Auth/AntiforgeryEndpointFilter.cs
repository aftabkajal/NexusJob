...
/// <c>POST /api/applications</c> endpoint. The token is seeded by
...
/// <c>NexusJob.Modules.JobPostings.Auth.AntiforgeryEndpointFilter</c>: modules
/// cannot reference each other's implementation (AD-1) and there is no shared
/// kernel, so this ~20-line filter is deliberately duplicated (spec Design Notes).
/// </summary>
