...
/// <summary>
/// Restricts an endpoint to authenticated <b>Job Seeker</b> callers (AD-13 /
...
/// <c>job_seeker</c> - so a genuinely signed-in Company is <em>forbidden</em>,
...
/// <c>internal AccountType</c> type (AD-1). A <c>job_seeker</c> variant of
/// <c>NexusJob.Modules.JobPostings.Auth.CompanyOnlyEndpointFilter</c>.
/// </summary>
internal sealed class JobSeekerOnlyEndpointFilter : IEndpointFilter
{
    ...
    /// <summary>The <c>account_type</c> claim value for a Job Seeker account.</summary>
    internal const string JobSeekerAccountType = "job_seeker";
        ...
        EndpointFilterDelegate next)
    {
        ...
        if (!string.Equals(accountType, JobSeekerAccountType, StringComparison.OrdinalIgnoreCase))
        {
            return Results.Problem(
                title: "This action is available to Job Seeker accounts only.",
